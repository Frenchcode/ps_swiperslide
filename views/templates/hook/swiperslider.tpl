    ...
    <div class="swiper">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide" id="creme-container">
                <div class="text-btn">
                    <h1>
                        <span id="slim-text">Slim</span>
                        <span id="xtrem-text">Xtrem'</span>
                    </h1>
                    <ul id="title-effects">
                        <li class="fade-item">
            ...
            <div class="swiper-slide" id="gain-container">
                <div class="text-btn mg-top-five">
                    <h1>
                        <span id="affin-text">Affiner &</span>
                        <br>
                        <span id="sculpter-text">Sculpter</span>
                        <br>
                        <span id="silhoutte-text">Votre Silhoutte</span>
                    </h1>
            ...
            <div class="swiper-slide" id="tissane-container">
                ...
                <div class="text-btn mg-top-five">
                    <h1>
                        ...
                        <br>
                        <span id="minc-text">Minceur</span>
                        <br>
                        <span id="daily-text">Au quotidien</span>
                    </h1>
